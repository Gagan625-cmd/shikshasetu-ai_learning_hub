...
export default function ContentGenerator() {
  ...
  const [contentType, setContentType] = useState<'notes' | 'summary' | 'worksheet' | 'mindmap' | 'questionpaper' | 'mcqs' | 'assertion' | 'casebased' | 'competency' | 'numerical'>('notes');
  ...
  const isMultiChapterMode = contentType === 'questionpaper';
...
- 5 MCQs (with options a, b, c, d - DO NOT write the correct answer next to the question)${isHigherGrade ? ' - At least 2 must be numerical-based MCQs' : ''}
- 5 Short Answer Questions (DO NOT write the answer below the question)${isHigherGrade ? ' - Include conceptual and application-based questions' : ''}
- 5 Long Answer/Problem Solving Questions (DO NOT write the solution below the question)${isHigherGrade ? ' - Include numerical problems and derivation-based questions' : ''}
Vary difficulty levels and include application-based questions.${isHigherGrade ? ' Follow the strict question distribution above.' : ''}
...
Provide all answers with detailed solutions.`;
      } else if (contentType === 'competency') {
...
Provide all answers with detailed explanations.`;
      } else if (contentType === 'numerical') {
        const numericalNote = hasNumericals 
          ? `Generate numerical/problem-solving questions for ${subjectName}.`
          : `Generate data-based and analytical problems for ${subjectName}. Focus on data interpretation, statistical analysis, and quantitative reasoning.`;
...
• Section A: 15 MCQs (1 mark each) = 15 marks
• Section B: 5 Very Short Answer (2 marks each) = 10 marks
• Section C: 7 Short Answer (3 marks each) = 21 marks
• Section D: 2 Case-Based/Source-Based (4 marks each) = 8 marks
• Section E: 3 Long Answer (5 marks each) = 15 marks
• Internal choices are provided in some questions.
• All questions are compulsory. However, internal choices have been provided.

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                    SECTION A (15 Marks)
           (15 MCQs carrying 1 mark each)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

[Generate exactly 15 MCQs numbered Q1 to Q15, 1 mark each, with 4 options (a, b, c, d):
${isHigherGrade ? `- Competency-Based MCQs (6) [COMPETENCY-BASED] - Application & real-world scenarios
- ${hasNumericals ? 'Numerical MCQs (3) [NUMERICAL] - At least 1 must be competency-based numerical' : 'Analytical MCQs (3)'}
- Assertion-Reason (3) with standard options:
  (a) Both A and R are true and R is the correct explanation of A.
  (b) Both A and R are true but R is NOT the correct explanation of A.
  (c) A is true but R is false.
  (d) A is false but R is true.
- Conceptual MCQs (3) [CONCEPTUAL]` : `- Conceptual (9)
- Assertion-Reason (3)
- COMPETENCY-BASED (3)`}]
...
[Generate 5 questions (Q16-Q20), 2 marks each. Internal choice in 1 question.${isHigherGrade ? `
- 2 Numerical problems [NUMERICAL] (1 must be competency-based numerical)
- 2 Competency-based questions [COMPETENCY-BASED]
- 1 Conceptual question [CONCEPTUAL]` : `
Include COMPETENCY-BASED and ${hasNumericals ? 'NUMERICAL' : 'ANALYTICAL'} questions.`}]
...
[Generate 7 questions (Q21-Q27), 3 marks each. Internal choice in 2 questions.${isHigherGrade ? `
...
- 1 Numerical + Conceptual mixed question` : `
Mix of competency, ${hasNumericals ? 'numerical' : 'analytical'}, and conceptual.`}]
...
[Generate 2 Case Studies (Q28-Q29), 4 marks each, with 4 sub-questions (1 mark each)]
[COMPETENCY-BASED] Each case study includes a real-world passage/scenario (5-8 lines) followed by 4 sub-questions.${isHigherGrade ? `
- Each case study MUST include at least 1 numerical sub-question requiring calculation
- Sub-questions should mix: identification (1 mark), numerical calculation (1 mark), application (1 mark), analysis (1 mark)
- At least 1 case study should be competency-based numerical (real-world data + calculation)` : ''}
...
[Generate 3 Long Answer questions (Q30-Q32), 5 marks each. Each question has an internal choice (OR).
${isHigherGrade ? `- Q30: Numerical problem (5 marks) [NUMERICAL] - Multi-step calculation with derivation. OR option also numerical.
- Q31: Competency-based numerical (5 marks) [COMPETENCY-BASED] [NUMERICAL] - Real-world scenario requiring calculations. OR option also competency-numerical.
- Q32: Conceptual + Numerical mixed (5 marks) - Theory (2 marks) + Numerical (3 marks). OR option similar mix.` : `Mix of competency-based, ${hasNumericals ? 'numerical/derivation' : 'analytical'}, and conceptual.`}]
...
- Include key formulas, definitions, and examples where relevant`;
  ...
  const exportToPDF = async () => {
    try {
      ...
      const contentTypeLabel = contentTypes.find(t => t.id === contentType)?.label || contentType;

      const html = generatePdfHtml(generatedContent, {
                    ...
                    return (
                      ...
                      >
                        ...
                        <View style={styles.chapterInfo}>
                          <Text style={[styles.chapterNumber, { color: colors.textTertiary }, isSelected && styles.chapterNumberActive]}>
                            Ch {chapter.number}
                          </Text>
                          <Text
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    ...
                    contentType === type.id && { backgroundColor: type.color + '20', borderColor: type.color },
                  ]}
