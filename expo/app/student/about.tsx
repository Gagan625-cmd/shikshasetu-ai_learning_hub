...
export default function AboutPage() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <LinearGradient
        colors={isDark ? ['#0a1628', '#0d2847', '#0e3460'] : ['#0ea5e9', '#0284c7', '#0369a1']}
      ...
      >
        <Animated.View style={{ opacity: fadeAnim }}>
          <View style={[styles.missionCard, { backgroundColor: isDark ? '#111827' : '#f0f9ff', borderColor: isDark ? '#1e3a5f' : '#bae6fd' }]}>
            <View style={styles.missionIconRow}>
              <Sparkles size={20} color="#0ea5e9" />
              <Text style={[styles.missionLabel, { color: isDark ? '#38bdf8' : '#0284c7' }]}>Our Mission</Text>
            </View>
          ...
          {[
            { emoji: '📚', title: 'AI Content Generator', desc: 'Generate comprehensive notes, summaries, worksheets, mind maps, and question papers for any chapter with AI assistance.' },
            { emoji: '📝', title: 'AI Exam Scanner', desc: 'Scan your exam papers and get instant AI-powered grading, detailed feedback, and personalized improvement plans.' },
            { emoji: '🎯', title: 'Adaptive Quiz Generation', desc: 'Practice with AI-generated quizzes that adapt to your learning level and provide instant feedback on your performance.' },
            { emoji: '💬', title: 'AI Interview Practice', desc: 'Prepare for interviews with AI-powered mock interviews, real-time feedback, and comprehensive performance analysis.' },
            { emoji: '📖', title: 'NCERT & ICSE Content', desc: 'Complete syllabus coverage for NCERT (Grades 6-10) and ICSE (Grades 9-10) with chapter-wise content generation.' },
            { emoji: '🌐', title: 'Multilingual Support', desc: 'Study in your preferred language with support for English, Hindi, and more regional languages.' },
            { emoji: '📊', title: 'Performance Analytics', desc: 'Track your learning progress with detailed analytics, activity history, and personalized insights.' },
            { emoji: '🔊', title: 'Text-to-Speech', desc: 'Listen to any generated content with high-quality text-to-speech in multiple languages for better accessibility.' },
          ].map((item, idx) => (
