      ...
      >
        <View style={[styles.selectionCard, { backgroundColor: colors.surface }]}>
          <View style={styles.selectionHeader}>
            ...
            <Text style={[styles.selectionTitle, { color: colors.text }]}>Select Your Chapter</Text>
          </View>
        ...
        {comicPanels.length > 0 && (
          <View style={styles.comicContainer}>
            ...
            <View style={[styles.summaryCard, { backgroundColor: isDark ? '#0a1a30' : '#eff6ff', borderColor: isDark ? '#1a3050' : '#bfdbfe' }]}>
              <Text style={[styles.summaryTitle, { color: isDark ? '#60a5fa' : '#1e40af' }]}>📝 Quick Recap</Text>
              {comicPanels.filter(p => p.keyPoint).map((panel, idx) => (
                <View key={`recap-${idx}`} style={styles.summaryItem}>
                  <Text style={[styles.summaryBullet, { color: isDark ? '#60a5fa' : '#3b82f6' }]}>•</Text>
        ...
        {!comicPanels.length && !isPending && (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyTitle, { color: colors.text }]}>Ready for Comic Learning?</Text>
