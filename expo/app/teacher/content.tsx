...
export default function TeacherContentBrowser() {
  ...
  const grades = useMemo(() => [6, 7, 8, 9, 10, 11, 12], []);
          ...
          <View key={subject.id} style={[styles.subjectCard, { backgroundColor: colors.cardBg }]}>
            ...
            <View style={styles.chaptersContainer}>
              {subject.chapters.map((chapter) => (
                <TouchableOpacity
                  key={chapter.id}
                  style={[styles.chapterItem, { backgroundColor: colors.surfaceElevated }]}
                  activeOpacity={0.7}
          ...
          >
            ...
            {generateContentMutation.isPending && (
              <View style={[styles.loadingCard, { backgroundColor: colors.cardBg }]}>
                <Text style={[styles.loadingText, { color: colors.textSecondary }]}>Generating comprehensive teaching material...</Text>
              </View>
            )}
            ...
            {generatedContent && (
              <View style={[styles.contentCard, { backgroundColor: colors.cardBg }]}>
                <View style={[styles.contentHeader, { borderBottomColor: colors.border }]}>
                  <Text style={[styles.contentHeaderTitle, { color: colors.text }]}>Teaching Material</Text>
