      ...
      >
        <View style={styles.linkCard}>
          <View style={styles.iconCircle}>
            <Globe size={40} color="#f59e0b" strokeWidth={2} />
          </View>

          <Text style={styles.cardTitle}>Teaching Video Resources</Text>
          <Text style={styles.cardDescription}>
            Access teaching video download resources to share with your students and enhance your lessons.
          </Text>

          <TouchableOpacity style={styles.linkButton} onPress={handleOpenLink} activeOpacity={0.8}>
            <LinearGradient colors={['#f59e0b', '#d97706']} style={styles.linkButtonGradient}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            This external resource provides teaching video downloads that you can use to create engaging lessons. Make sure you have an internet connection to access it.
          </Text>
        </View>
      </ScrollView>
    </View>
